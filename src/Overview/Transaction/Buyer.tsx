  ...
  return (
    <div className="w-full h-full px-4 pt-24 flex flex-col gap-7 ">
      ...
      <form className="flex flex-col gap-5">
        ...
        <div className="flex justify-between items-center w-full h-1007 rounded-lg text-white border-2 border-solid border-purple  bg-black px-3"><p>Choose a pickup method</p><FaAngleDown/></div>
      </form>
