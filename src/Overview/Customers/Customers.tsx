     ...
     <div className="flex flex-col  w-full border border-demotext rounded-lg ">
       <div className="w-full  border-b border-demotext  p-4 sm:p-6 flex  items-center justify-between">
        <div className='w-full h-full flex items-center gap-5'>
         ...
         <div className='flex items-center gap-1 sm:gap-2 h-10 hover:cursor-pointer text-sm sm:text-base bg-purple rounded-lg px-2 sm:px-3'><p>message</p><FaMessage className='mt-1'/></div>
       </div>
       <div className="w-full  border-b border-demotext  p-4 sm:p-6 flex justify-between">
        <div className='w-full h-full flex items-center gap-5'>
         ...
         <div className='flex items-center gap-1 sm:gap-2 h-10 bg-purple text-sm sm:text-base rounded-lg px-2 sm:px-3'><p>message</p><FaMessage className='mt-1'/></div>
       </div>
     </div>
   </div>
 </div>
