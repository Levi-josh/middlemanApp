...
const Firstpage = () => {
  return (
    <div className="w-full overflow-auto     lg:px-5   lg:w-1075 h-full">
    <Header/>
    <div className="flex flex-col px-3 justify-between sm:px-4  lg:gap-6 pt-14 lg:py-0  lg:flex-row lg:justify-between  lg:items-center h-full lg:h-103 ">
      <div className="lg:w-107 w-full rounded-lg h-102 lg:h-full  bg-black px-2 lg:px-3  lg:gap-2 flex-col flex justify-center items-start ">
        ...
        <p className="text-white sm:text-lg lg:text-xl font-bold">Levi joshua</p>
        </div>
