...
const ChatHeader = (props:any) => {
  ...
  return (
    <div className="w-full z-50 bg-black lg:w-1069 xl:w-1074 px-3 top-0  sm:px-4 md:px-5 lg:px-3 flex items-center   justify-between fixed h-16 sm:h-20 md:h-24 lg:h-20">
