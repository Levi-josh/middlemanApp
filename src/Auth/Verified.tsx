        ...
        <div  className="flex flex-col fixed items-center justify-center  bg-black  gap-7 w-full h-screen ">
            ...
            <div className='w-full flex items-center flex-col gap-5 sm:gap-7 '>
                <div className='flex flex-col items-center text-white gap-3'>
                    <div className='sm:w-20 sm:h-20 w-14 h-14 rounded-full flex justify-center items-center text-white bg-purple text-xl sm:text-2xl'><FaCheck/></div>
                    <h1 className="text-white text-center font-semibold text-lg sm:text-xl">Verification completed</h1>
                </div>
                <p className='flex w-full text-white items-center font-sans gap-2 text-sm sm:text-base justify-center text-center '>You have successfully registered as a user. Click on the button below to continue</p>
            </div>
