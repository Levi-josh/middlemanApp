      ...
      {switchForm ?
        ...
        <div className="lg:px-7 lg:py-7 py-4 sm:py-6   overflow-x-hidden   flex flex-col gap-7 sm:gap-10 lg:gap-9 ">
          <div className="flex flex-col lg:items-center relative   justify-between w-full gap-4 ">
              ...
              <div  className={`w-full text-white flex  flex-col justify-around items-center ${fixedBody?'hidden':'h-103'} top-16 absolute lg:hidden transition-all  before:bg-black before:h-103 before:w-full before:absolute before:bg-opacity-20 backdrop-blur-2xl`}>
                <p>Sign In</p>
                <p>Sign Up</p>
                <p>About Us</p>
                <p>Contact Us</p>
          ...
          {middlemanImage&&<motion.div className="w-full  rounded-xl h-auto  md:pb-6 md:pr-0 md:pl-6 md:pt-6 mt-3 sm:mt-5 gap-7 sm:gap-10 md:gap-0   md:bg-black  flex flex-col md:flex-row   "  variants={textRevealVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }}>
            <img src={middlemanImage} className="bg-no-repeat bg-cover bg-center  md:w-105 h-auto   md:rounded-e-none w-full object-cover  "/> 
