...
const changeForm = () => {
  ...
  return (
    <div className="bg-black2 w-full h-full px-4 sm:px-6 md:px-8 lg:px-0 lg:flex justify-center overflow-auto  lg:justify-normal fixed  ">
      {switchForm ?
        <form onSubmit={signUpHandSubmit} className="bg-black w-109 hidden h-108 sm:w-1065 md:w-106 lg:w-109 xl:w-107 lg:h-full lg:flex flex-col justify-center  px-4 ">
          ...
          <div className="flex flex-col gap-5 mt-5 w-full justify-center items-center">
            ...
            <p className="text-white">Dont have an account? <span className="text-purple font-semibold  cursor:pointer" onClick={changeForm}>Signup</span></p>
          </div>
        </form>
        :
        <form onSubmit={signInHandSubmit} className="bg-black w-109 hidden h-108 sm:w-1065 md:w-106 lg:w-109 xl:w-107 lg:h-full lg:flex flex-col justify-center  px-4 ">
          ...
          <div className="flex flex-col gap-5 mt-5 w-full justify-center items-center">
            ...
            <div className="w-full h-10 rounded-full bg-black2 text-white flex justify-center items-center text-base">Google</div>
            <p className="text-white">Already have an account? <span className="text-purple font-semibold"onClick={changeForm}>SignIn</span></p>
          </div>
        </form>}
        <div className="lg:px-7 lg:pt-7 overflow-auto flex flex-col gap-7 sm:gap-10 lg:gap-9 ">
          <div className="flex flex-col lg:items-center  justify-between w-full gap-4 ">
              <div className="flex lg:hidden  pt-4 sm:pt-6 justify-between items-center ">
              ...
              <h1 className="text-white font-bold text-lg sm:text-2xl">Welcome to The Middleman</h1>
              <h2 className="text-white text-center text-sm font-sans sm:text-base">Your Trusted Escrow Service for Secure Transactions...</h2>
              </div>
          </div>
          ...
          whileInView="visible"
           viewport={{ once: true, amount: 0.5 }}>
            ...
            <div className="md:w-105 md:pb-6 p-3 sm:p-5 md:pt-0  md:pl-5 md:pr-2 flex flex-col gap-3 md:gap-1">
              <motion.h1 className="font-bold text-purple text-xl lg:text-2xl text-center " variants={itemFromTopVariants}>About us</motion.h1>
              <motion.div variants={itemFromRightVariants}>
      ...
      whileInView="visible"
      viewport={{ once: true, amount: 0.5 }}>
        <motion.h1 className="text-purple font-bold text-xl text-center md:text-start lg:text-2xl"variants={itemFromTopVariants}>
          How It Works
        </motion.h1>
      <div className="text-white text-sm sm:text-base flex flex-col gap-4 sm:gap-5">
        <div className="flex gap-2 items-start" >
          ...
          <motion.p variants={itemFromRightVariants}>Buyer and Seller Agreement - The buyer and seller agree on the terms of the transaction.</motion.p>
        </div>
        <div className="flex gap-2 items-start" >
          ...
          <motion.p variants={itemFromRightVariants}>Secure Payment - The buyer deposits the payment with The Middleman.</motion.p>
        </div>
        <div className="flex gap-2 items-start" >
          ...
          <motion.p variants={itemFromRightVariants}>Product Delivery - The seller ships the product or provides the service.</motion.p>
        </div>
        <div className="flex gap-2 items-start" >
          <motion.div className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0 rounded-full bg-purple flex items-center justify-center text-xs" variants={itemFromLeftVariants}>4</motion.div>
          <motion.p variants={itemFromRightVariants}>Confirmation - The buyer confirms receipt and satisfaction with the item.</motion.p>
        </div>
        <div className="flex gap-2 items-start" >
          <motion.div className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0 rounded-full bg-purple flex items-center justify-center text-xs" variants={itemFromLeftVariants}>5</motion.div>
          <motion.p variants={itemFromRightVariants}>Release of Funds - The Middleman releases the payment to the seller.</motion.p>
        </div>
      </div>
    </motion.div>
    <motion.div
