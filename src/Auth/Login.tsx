      ...
      {switchForm ?
        ...
        <div className="lg:px-7 lg:py-7 py-4 sm:py-6   overflow-x-hidden   flex flex-col gap-7 sm:gap-10 lg:gap-9 ">
          <div className="flex flex-col lg:items-center relative    justify-between w-full gap-4 ">
              ...
              <div  className={`w-full text-white flex sm:text-lg  flex-col justify-around items-center ${fixedBody?'hidden':'h-103'} top-16 absolute lg:hidden transition-all   before:h-103 before:w-full before:absolute before:bg-opacity-20 backdrop-blur-2xl`}>
