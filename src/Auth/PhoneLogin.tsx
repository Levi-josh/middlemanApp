  ...
  return (
    <div className="flex justify-center w-full h-screen bg-black items-center">
        ...
        <form onSubmit={handSubmit} className="bg-black w-109 lg:hidden h-108 sm:w-1065 md:w-106 lg:w-106 xl:w-105 lg:h-full flex flex-col items-center justify-between  ">
          ...
          <div className="flex flex-col w-full items-center pt-7 sm:pt-0   h-10008 justify-start">
            <div className="flex flex-col gap-7 sm:gap-10 w-full justify-center items-center">
              ...
              <button className="w-full rounded-full h-10 sm:h-12 bg-purple text-white">Sign In</button>
            </div>
            <div className="flex flex-col gap-5 sm:gap-7 mt-5 sm:mt-7 w-full justify-center items-center">
              ...
              <p className="text-white">Dont have an account? <span className="text-purple font-semibold">Signup</span></p>
            </div>
          </div>
        </form>  
    </div>
