...
const ChatFooter = () => {
  return (
    <div className="w-full z-10 bg-black lg:w-1025 px-3 sm:px-4 md:px-5 lg:px-3 flex items-center bottom-0  justify-between fixed h-14 sm:h-16 md:h-20">
        ...
        <input className="w-107 bg-black1 border border-solid border-gray-800 text-white outline-none rounded-full placeholder:pl-1 pl-5 sm:py-1" placeholder="Enter text"/>
