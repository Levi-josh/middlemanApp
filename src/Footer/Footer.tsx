...
const Footer:React.FC<FooterProps> = ({ goToSlide }) => {
  ...
  return (
    ...
    <div className="flex flex-col items-center" onClick={()=>{goToSlide(0);navigateIcon(false)}}>
    <svg width="24" height="24" viewBox="0 0 24 24" fill={`${changeIcon?'none':'white'}`} xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="flex flex-col items-center" onClick={()=>{goToSlide(1);navigateIcon(true)}}>
    <svg width="24" height="24" viewBox="0 0 24 24" fill={`${changeIcon?'white':'none'}`} xmlns="http://www.w3.org/2000/svg">
