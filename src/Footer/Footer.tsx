...
const Footer:React.FC<FooterProps> = ({ goToSlide, iconFill}) => {
  return (
    ...
    <svg width="24" height="24" viewBox="0 0 24 24" fill={`${iconFill?'white':'none'}`} xmlns="http://www.w3.org/2000/svg">
    ...
    <svg width="24" height="24" viewBox="0 0 24 24" fill={`${iconFill?'none':'white'}`} xmlns="http://www.w3.org/2000/svg">
